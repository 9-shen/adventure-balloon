<x-filament-panels::page>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 dark:text-gray-500">
                                Click on any date to view booking statistics
                            </p>
                        </div>
                    </div>
                            ...
                            <button
                                ...
                                class="min-h-[88px] p-2 text-left transition-all duration-150 group relative
                                    @if($selectedDate === $day['date'])
                                        bg-blue-50 dark:bg-blue-900/20 ring-inset ring-2 ring-blue-400 dark:ring-blue-600
                                    @elseif($day['is_today'])
        ...
        <div class="flex flex-col gap-5">
            ...
            @if($selectedDate)
                <div class="bg-white dark:bg-gray-900 rounded-2xl border-2 border-blue-300 dark:border-blue-700 shadow-sm p-5">
                    {{-- Header --}}
                    ...
                    @else
                        ...
                        <div class="grid grid-cols-3 gap-3 mb-4">
                            <div class="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-3 text-center">
                                ...
                                <p class="text-[10px] font-medium text-blue-500 dark:text-blue-400 mt-1 uppercase tracking-wide">Total</p>
                            </div>
                            <div class="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl p-3 text-center">
                                <p class="text-2xl font-extrabold text-indigo-700 dark:text-indigo-300 leading-none">
                                    {{ $selectedDayStats['regularCount'] }}
                                </p>
                                <p class="text-[10px] font-medium text-indigo-500 dark:text-indigo-400 mt-1 uppercase tracking-wide">Regular</p>
                            </div>
