        ...
        <div class="flex flex-col gap-5">
            ...
            @if($selectedDate)
                <div class="bg-white dark:bg-gray-900 rounded-2xl border-2 border-violet-300 dark:border-violet-700 shadow-sm p-5">
                    ...
                    @else
                        {{-- Total — full-width pill --}}
                        <div class="bg-violet-50 dark:bg-violet-900/20 rounded-xl p-4 text-center mb-3">
                            <p class="text-3xl font-extrabold text-violet-700 dark:text-violet-300 leading-none">
                                {{ $selectedDayStats['totalCount'] }}
                            </p>
                            <p class="text-[10px] font-semibold text-violet-500 dark:text-violet-400 mt-1.5 uppercase tracking-widest">Total</p>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-4">
                            ...
                            <div class="rounded-xl p-3 text-center border border-gray-100 dark:border-gray-800">
                                <p class="text-2xl font-extrabold text-violet-600 dark:text-violet-400 leading-none">
                                    {{ $selectedDayStats['partnerCount'] }}
                                </p>
                                <p class="text-[10px] font-semibold text-violet-500 dark:text-violet-400 mt-1.5 uppercase tracking-widest">Partner</p>
                            </div>
                        </div>
