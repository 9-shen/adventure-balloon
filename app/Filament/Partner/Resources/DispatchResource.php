...
use App\Filament\Partner\Resources\DispatchResource\Pages\ListDispatches;
use App\Filament\Partner\Resources\DispatchResource\Pages\ViewDispatch;
...
class DispatchResource extends Resource
{
    ...
    // ─── Query scope — only dispatches for this partner's bookings ────────────
    ...
    // ─── Table — reuses the Guide table (same columns, read-only) ────────────
