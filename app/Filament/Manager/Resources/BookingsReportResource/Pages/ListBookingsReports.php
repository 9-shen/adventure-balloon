...
namespace App\Filament\Manager\Resources\BookingsReportResource\Pages;

use App\Filament\Manager\Resources\BookingsReportResource;
...
class ListBookingsReports extends ListRecords
{
    ...
    public function getTabs(): array
    {
        return [
            ...
            'regular' => \Filament\Schemas\Components\Tabs\Tab::make('Regular')
                ->modifyQueryUsing(fn (\Illuminate\Database\Eloquent\Builder $query) => $query->where('type', 'regular')),
                
            'partner' => \Filament\Schemas\Components\Tabs\Tab::make('Partner')
                ->modifyQueryUsing(fn (\Illuminate\Database\Eloquent\Builder $query) => $query->where('type', 'partner')),
        ];
    }
}
