...
class PaxStatsReport extends Page implements HasTable
{
    ...
    {
        return [
            \App\Filament\Accountant\Pages\Reports\Widgets\PaxStatsWidget::class,
        ];
    }
        ...
        return $table
            ...
            ->bulkActions([
                \Filament\Actions\BulkAction::make('export_selected')
                    ...
                    ->icon('heroicon-o-arrow-down-tray')
                    ->color('success')
                    ->action(function (\Filament\Actions\BulkAction $action, \Livewire\Component $livewire) {
                        // For aggregate queries with custom keys, Eloquent models fail to resolve automatically.
                        // We must fetch the raw keys directly from the Livewire component.
