...
class TransporterBillingResource extends Resource
{
    ...
    {
        return [
            'index'  => \App\Filament\Accountant\Resources\TransporterBillingResource\Pages\ListTransporters::route('/'),
            'manage' => \App\Filament\Accountant\Resources\TransporterBillingResource\Pages\ViewTransporterDispatches::route('/{record}/dispatches'),
        ];
    }
}
