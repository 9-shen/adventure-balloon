...
class PartnerInvoiceResource extends Resource
{
            ...
            ->actions([
                TableAction::make('view_bookings')
                    ...
                    ->url(fn (Partner $partner): string =>
                        \App\Filament\Accountant\Resources\PartnerInvoiceResource::getUrl('manage', ['record' => $partner->id])
                    ),
            ])
    ...
    {
        return [
            'index'  => \App\Filament\Accountant\Resources\PartnerInvoiceResource\Pages\ListPartnerInvoices::route('/'),
            'manage' => \App\Filament\Accountant\Resources\PartnerInvoiceResource\Pages\ViewPartnerBookings::route('/{record}/bookings'),
        ];
    }
}
