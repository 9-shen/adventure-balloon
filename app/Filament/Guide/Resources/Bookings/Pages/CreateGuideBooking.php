...
class CreateGuideBooking extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        return array_merge($data, $pricing, [
            ...
            'guide_id'       => $user->guide_id,       // ← link to guide
            'booking_ref'    => $ref,
    ...
    protected function afterCreate(): void
    {
        ...
        if ($adminEmail) {
            try {
                ...
                Log::error("GuidePortal: failed to send booking alert [{$booking->booking_ref}]: " . $e->getMessage());
            }
        }
