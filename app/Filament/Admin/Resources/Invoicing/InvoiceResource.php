...
class InvoiceResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Admin\Resources\Invoicing\InvoiceResource\Pages\ListInvoices::route('/'),
            'view'  => \App\Filament\Admin\Resources\Invoicing\InvoiceResource\Pages\ViewInvoice::route('/{record}'),
        ];
    }
}
