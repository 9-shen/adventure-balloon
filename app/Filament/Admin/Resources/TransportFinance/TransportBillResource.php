...
class TransportBillResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Admin\Resources\TransportFinance\TransportBillResource\Pages\ListTransportBills::route('/'),
            'view'  => \App\Filament\Admin\Resources\TransportFinance\TransportBillResource\Pages\ViewTransportBill::route('/{record}'),
        ];
    }
}
