...
use App\Filament\Admin\Resources\DeletionRecords\DispatchResource\Pages;

class DispatchResource extends Resource
{
    protected static ?string $model = Dispatch::class;
    protected static ?string $slug = 'deleted-dispatches';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('dispatch_ref')
                    ->label('Identifier')
                    ->searchable()
                    ->sortable(),
    ...
    {
        return [
            'index' => Pages\ManageDispatchs::route('/'),
        ];
    }
}