...
use App\Filament\Admin\Resources\DeletionRecords\BalloonDispatchResource\Pages;

class BalloonDispatchResource extends Resource
{
    protected static ?string $model = BalloonDispatch::class;
    protected static ?string $slug = 'deleted-balloon-dispatches';
    ...
    {
        return [
            'index' => Pages\ManageBalloonDispatches::route('/'),
        ];
    }
}
