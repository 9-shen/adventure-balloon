...
use App\Filament\Admin\Resources\DeletionRecords\TransportBillResource\Pages;

class TransportBillResource extends Resource
{
    protected static ?string $model = TransportBill::class;
    protected static ?string $slug = 'deleted-transport-bills';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('bill_ref')
                    ->label('Identifier')
                    ->searchable()
                    ->sortable(),
    ...
    {
        return [
            'index' => Pages\ManageTransportBills::route('/'),
        ];
    }
}