...
use App\Filament\Admin\Resources\DeletionRecords\TransportCompanyResource\Pages;

class TransportCompanyResource extends Resource
{
    protected static ?string $model = TransportCompany::class;
    protected static ?string $slug = 'deleted-transport-companies';
    ...
    {
        return [
            'index' => Pages\ManageTransportCompanys::route('/'),
        ];
    }
}